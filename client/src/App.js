              ...
              <Routes>
                ...
                {user.loggedIn && (
                  <>
                    ...
                    <Route path='/mytodo/categories' element={<ProtectedRoute user={user}><Categories user={user}/></ProtectedRoute>}/>
                    <Route path='/mytodo/pinned' element={<ProtectedRoute user={user}><Pinned/></ProtectedRoute>}/>
                    <Route path='/mytodo/shared' element={<ProtectedRoute user={user}><Shared user={user}/></ProtectedRoute>}/>
                  </>
                )}
